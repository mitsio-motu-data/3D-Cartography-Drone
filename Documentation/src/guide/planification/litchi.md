...
| Cruising & Max Flight speed | Titres explicites. | <ul><li>CS : 11km/s</li><li>MFS : 15km/s</li></ul> | <ul><li>CS : 11km/s</li><li>MFS : 15km/s</li></ul> |
...
Une fois tout cela fait, plus qu'à sauvegarder ! Pour cela, rendez vous dans `MISSIONS > Save...` et nommez votre mission. Rappelez vous de bien utiliser la nomenclature définie, comme expliqué dans la section [Planification de la mission](planification.md). Vos modifications ne sont pas enregistrées en temps réal. Alors si vous modifiez la mission, pensez bien à la sauvegarder avec la même procédure. En conservant le même nom de mission, les modifications seront enregistrées sans créer de nouvelle mission.
...
Les missions sont automatiquement synchronisées et sont tout de suite accessible depuis l'application mobile. Pour y accéder, commencez par télécharger l'application et à l'ouvrir.
